...
**Current release: [v2.1.162](https://github.com/HansBug/claude-portable/releases/tag/v2.1.162)** · [All releases](https://github.com/HansBug/claude-portable/releases)
...
cd claude-portable-linux-x64-v2.1.162   # strip .tar.gz
./claude --version
```
