...
**当前版本：[v2.1.131](https://github.com/HansBug/claude-portable/releases/tag/v2.1.131)** · [所有版本](https://github.com/HansBug/claude-portable/releases)
...
cd claude-portable-linux-x64-v2.1.131   # 去掉 .tar.gz 后缀
./claude --version
```
